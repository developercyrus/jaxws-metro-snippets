 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://server.example3.metro.jaxws.javase/", wsdlLocation = "http://localhost:9876/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://server.example3.metro.jaxws.javase/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://server.example3.metro.jaxws.javase/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.example3.metro.jaxws.javase/", "TimeServerImplPort"), TimeServer.class, features);
    }
